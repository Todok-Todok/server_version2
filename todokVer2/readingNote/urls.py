...
urlpatterns = [
    path('prereading/<int:user_id>/<int:opponent_user_id>/<int:book_id>/', views.PreReadingNoteListAPIView.as_view()),
    ...
    path('ongoing/<int:user_id>/<int:opponent_user_id>/<int:book_id>/', views.OngoingReadingNoteAPIView.as_view())
]